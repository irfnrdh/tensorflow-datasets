...
class PlantaeKTest(testing.DatasetBuilderTestCase):
  ...
  DL_EXTRACT_RESULT = {
      fname: fname for fname in [
          "{}1.JPG".format(label_tag) for label_tag in [
              "apple_d", "apple_h", "apricot_d", "apricot_h", "cherry_d",
              "cherry_h", "cranberry_d", "cranberry_h", "grapes_d", "grapes_h",
              "peach_d", "peach_h", "pear_d", "pear_h", "walnut_d", "walnut_h",
              "walnut-h"
          ]
      ]
  }
